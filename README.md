...
A modular Telegram Group Management bot, can be found on telegram as [Marin](https://t.me/MarinKawaiiBot).

The Support group can be reached out to at [Support](https://t.me/KaizenSupport), where you can ask for help about Shikimori Bot, discover/request new features, report bugs, and stay in the loop whenever a new update is available. 
