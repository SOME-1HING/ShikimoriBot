...
from Shikimori.modules.helper_funcs.decorators import Shikimoricmd, Shikimoricallback
...
# Callback Data
@Shikimoricallback(pattern=r"drama-detail.*")
...
@Shikimoricallback(pattern=r"drama-cast-detail.*")
