...
def afk(update, context):
    ...
    try:
        Shikimori = update.message.reply_video("https://telegra.ph/file/bfe511a9f3b1bf225c144.mp4").caption(
            "`{}` is now AFK! Sayonara!".format(fname), parse_mode=ParseMode.MARKDOWN)
        time.sleep(5)
        try:
            Shikimori.delete()
        except BadRequest:
